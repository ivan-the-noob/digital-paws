...
<body>
    ...
    <div class="navbar flex-column bg-white shadow-sm p-3 collapse d-md-flex" id="navbar">
        <div class="navbar-links">
            ...
            <a href="check-up.php" class="navbar-highlight">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row d-flex">
                            ...
                            <div class="form-group col-md-5">
                                <div class="form-floating">
                                    <input type="number" class="form-control" id="active-number" name="active_number"
                                        required>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td colspan="2" rowspan="8">
                                                <textarea type="text" class="form-control h-100 input-col"
                                                    name="chief_complaint" rows="3" style="border: none;"
                                                    required></textarea>
                                            </td>
                                            <td colspan="2" rowspan="8">
                                                <textarea class="form-control h-100" name="treatment" rows="3"
